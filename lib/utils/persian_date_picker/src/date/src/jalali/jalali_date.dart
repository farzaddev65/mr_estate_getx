...
class Jalali implements Date, Comparable<Jalali> {
  ...
  ///
  /// non-null
  Jalali(this.year, [this.month = 1, this.day = 1, this.hour = 0, this.minute = 0, this.second = 0]) {
  ...
  /// non-null
  @override
  Jalali copy({int? year, int? month, int? day, int? hour, int? minute, int? second}) {
    if (year == null && month == null && day == null && hour == null && minute == null && second == null) {
      return this;
    } else {
      return Jalali(year ?? this.year, month ?? this.month, day ?? this.day, hour ?? this.hour, minute ?? this.minute, second ?? this.second);
    }
  }
  ...
  /// non-null
  @override
  Jalali add({int years = 0, int months = 0, int days = 0, int hours = 0, int minutes = 0, int seconds = 0}) {
    ...
    if (years == 0 && months == 0 && days == 0 && hours == 0 && minutes == 0 && seconds == 0) {
      ...
      return Jalali(year + years, month + months, day + days, hour + hours, minute + minutes, second + seconds);
    }
  }
