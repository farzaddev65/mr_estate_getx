...
class Gregorian implements Date, Comparable<Gregorian> {
  ...
  int get julianDayNumber {
    return (((year + ((month - 8) ~/ 6) + 100100) * 1461) ~/ 4) + ((153 * ((month + 9) % 12) + 2) ~/ 5) + day - 34840408 - ((((year + 100100 + ((month - 8) ~/ 6)) ~/ 100) * 3) ~/ 4) + 752;
  }
  ...
  Gregorian(this.year, [this.month = 1, this.day = 1, this.hour = 0, this.minute = 0, this.second = 0]) {
