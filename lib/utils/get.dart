...
bool isPersianLang() => (Hive.box(AppConstants.HIVE_LOCAL_STORAGE).get('locale') ?? 'fa') == 'fa';
...
Future<dynamic> setStorage(String key, dynamic value) async {
  Box box =await Hive.openBox(AppConstants.HIVE_LOCAL_STORAGE);
  box.put(key, value);
  box.close();
}
